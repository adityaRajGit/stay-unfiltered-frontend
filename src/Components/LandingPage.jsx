...
import people3 from "../assets/people/nonresident-yUHSvoZQp20-unsplash.jpg";
import people4 from "../assets/people/marc-kleen-Iskck0kl210-unsplash.jpg";
import people5 from "../assets/people/naim-ahmed-8BcVHmAHtlw-unsplash.jpg";
  ...
  return (
    <div className="relative w-full bg-teal-200">
      ...
      <header className="py-4 md:py-6">
        <div className="container px-4 mx-auto sm:px-6 lg:px-8"></div>
      </header>
